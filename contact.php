    ...
    <div class="container">
        <div class="row gy-3 gy-md-4 gy-lg-0 align-items-xl-center">
            <div class="col-12 col-lg-6">
                <img class="img-fluid rounded object-fit-cover" loading="lazy" src="https://plus.unsplash.com/premium_photo-1685366454664-1b0fb96f216f?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Get in Touch" />
            </div>
            <div class="col-12 col-lg-6">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label for="email" class="form-label">Adresse mail<span class="text-danger">
                                                *</span></label>
                                    ...
                                    <div class="col-12">
                                        <label for="subject" class="form-label">Suject <span class="text-danger">*</span></label>
