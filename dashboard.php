...
<body>
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">CoachMe</a>
            ...
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="sidebarMenuLabel">CoachMe</h5>
                    ...
                    <table class="hover row-border stripe" id="dashboards" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($coach->cv !== NULL) { ?><a
                                        class="btn btn-primary d-flex justify-content-center"
                                        href="static/uploads/cv/<?= $coach->cv ?>">Show
                                        CV</a><?php } else {
                                                                                                                                                                                            echo "Pas de cv";
                                                                                                                                                                                        } ?>
                                </td>
                                <td><a class="btn btn-primary d-flex justify-content-center"
                                        href="show.php?coach=<?= $coach->id ?>">Show profile</a></td>
                                <td>
                                    <form method="POST" class="d-flex justify-content-center">
                                        <input type="number" id="hide" name="hide" value="" hidden>
                                        <a type="button" class="btn btn-danger w-100 me-1" id="messag" name="messag"
                                            data-bs-toggle="modal" data-bs-target="#exampleModal"
                                            onclick="addValueTo(<?= $coach->id ?>)"><i
                                                class="bi bi-chat-dots-fill"></i></a>
                                        <button type="submit" class="btn btn-success w-100 ms-1" id="accept"
                                            name="accept" value="<?= $coach->id ?>"><i class="bi bi-check"></i></button>
                                    </form>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="message-alert"
                                            name="message-alert">Send</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="hover row-border stripe" id="messageAlert" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" class="d-flex justify-content-center">
                                        <button type="submit" class="btn btn-danger w-100 me-1" id="user-messag-Id"
                                            name="user-messag-Id" value="<?= $messagUser->id_user ?>"><i
                    ...
                    <table class="hover row-border stripe" id="users" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" class="d-flex justify-content-center">
                                        <button type="submit" class="btn btn-danger w-100 me-1" id="userId"
                                            name="userId" value="<?= $user->id ?>"><i class="bi bi-trash"></i></button>
                                    </form>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                    ...
                    <table class="hover row-border stripe" id="contacts" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" class="d-flex justify-content-center">
                                        <button type="submit" class="btn btn-danger w-100 me-1" id="messagId"
                                            name="messagId" value="<?= $contact->id ?>"><i
                                                class="bi bi-trash"></i></button>
                                    </form>
                                </td>
                            </tr>
