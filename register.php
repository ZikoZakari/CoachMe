                ...
                <div class="card card-registration my-4">
                    <div class="row g-0">
                        <div class="col-xl-6 d-none d-xl-block">
                            <img src="static/images/register-pic.jpg" alt="Sample photo"
                            ...
                            <div class="card-body p-md-5">
                                ...
                                <form method="POST">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="form-floating">
                                                <input type="password" placeholder="Confirm password" id="passwordc"
                                                    name="passwordc" class="form-control form-control-lg" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <select class="form-select form-select-lg fs-6" id="city" name="city"
                                                placeholder='City'>
                                    ...
                                    <div class="d-flex justify-content-end pt-3">
                                        <button type="reset" class="btn btn-danger btn-lg fs-6 text-md">Reset
                                            all</button>
                                        <input type="submit" class="btn btn-success btn-lg fs-6 ms-2" name="register"
                                            value="Register now">
                                    </div>
                                </form>
                            </div>
